...
const ProfilePage = () => {
    const reports = [
        { title: "Pollution", date: "Sept 11 2025 - 9:20 AM", status: "Pending" },
        { title: "High Tides", date: "Sept 10 2025 - 4:35 PM", status: "Verified" },
        { title: "Flooding", date: "July 21 2025 - 1:11 PM", status: "Verified" },
    ];
    ...
    <div className="min-h-screen bg-[#F4FEFF] flex flex-col items-center p-4 pb-[10vh]">
            {/* Profile Header */}
            <h1 className='text-center font-medium text-2xl mt-4'>Profile</h1>
